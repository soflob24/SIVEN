...
<div class="card">
    ...
    <div class="card-body">
        <button class="btn btn-primary mb-3" type="button" onclick="frmCaja();">Nueva <i class="fas fa-plus"></i></button>
...
<!-- Modal -->
<div id="nuevaCaja" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">

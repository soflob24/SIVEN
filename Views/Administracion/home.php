...
<div class="row">
    <div class="col-xl-3 col-md-6">
        <div class="card bg-primary">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                <a href="<?php echo base_url; ?>Usuarios" class="text-white text-decoration-none">Ver detalle</a>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-success">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                <a href="<?php echo base_url; ?>Clientes" class="text-white text-decoration-none">Ver detalle</a>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-danger">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                <a href="<?php echo base_url; ?>Productos" class="text-white text-decoration-none">Ver detalle</a>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-warning">
            <div class="card-body d-flex text-white">
                Ventas por Día
                <i class="fa-solid fa-cash-register fa-2x ms-auto"></i>
            </div>
            <div class="card-footer d-flex align-items-center justify-content-between">
                <a href="<?php echo base_url; ?>Compras/historial_ventas" class="text-white text-decoration-none">Ver detalle</a>

...
class Usuarios extends Controller{
    ...
    public function registrar(){
        ...
        if (empty($usuario) || empty($nombre) || empty($caja)) {
            ...
            if ($id == "") {
                ...
                if ($data == "modificado") {
                    $msg = array('msg' => 'Usuario modificado exitosamente', 'icono' => 'success');
                }else{
    ...
    public function eliminar(int $id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Usuario eliminado exitosamente', 'icono' => 'success');
        }else{
        ...
        if (empty($actual) || empty($nueva) || empty($confirmar)){
            ...
            if ($nueva != $confirmar) {
                ...
                if (!empty($data)) {
                    ...
                    if ($verificar == 1) {
                        $mensaje = array('msg' => 'Contraseña modificada exitosamente', 'icono' => 'success');
                    }else {
                        $mensaje = array('msg' => 'Error al modificar la contraseña', 'icono' => 'error');
                    }
                }else {
                    $mensaje = array('msg' => 'Contraseña actual incorrecta', 'icono' => 'error');
                }
            }
        }

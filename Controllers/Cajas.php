...
class Cajas extends Controller{
    ...
    public function registrar(){
        ...
        if (empty($caja)) {
            ...
            if ($id == "") {
                ...
                if ($data == "ok") {
                    $msg = array('msg' => 'Caja registrada exitosamente', 'icono' => 'success');
                }else if($data == "existe") {
                ...
                if ($data == "modificado") {
                    $msg = array('msg' => 'Caja modificada exitosamente', 'icono' => 'success');
                }else{
    ...
    public function abrirArqueo(){
        ...
        if (empty($monto_inicial)) {
            ...
            if ($id == '') {
                ...
                if ($data == "ok") {
                    $msg = array('msg' => 'Caja abierta exitosamente', 'icono' => 'success');
                }else if($data == "existe") {
                ...
                if ($data == "ok") {
                    ...
                    $msg = array('msg' => 'Caja cerrada exitosamente', 'icono' => 'success');
                }else{
    ...
    public function eliminar(int $id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Caja eliminada exitosamente', 'icono' => 'success');
        }else{
    ...
    public function reingresar(int $id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Caja reingresada exitosamente', 'icono' => 'success');
        }else{

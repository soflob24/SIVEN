...
class ComprasModel extends Query{
    ...
    public function registrarCompra(int $id_proveedor, string $total)
    {
        $sql = "INSERT INTO compras(id_proveedor, total) VALUES (?,?)";
    ...
    {
        $sql = "SELECT proveedores.id, proveedores.proveedor, compras.* FROM proveedores INNER JOIN compras ON compras.id_proveedor = proveedores.id";
        $data = $this->selectAll($sql);
        return $data;
    }
    ...
    {
        $sql = "SELECT c.id, c.id_proveedor, proveedores.* FROM compras c INNER JOIN proveedores ON proveedores.id = c.id_proveedor WHERE c.id = $id";
        $data = $this->select($sql);
        return $data;
    }
